...
Intranet Single Page Application for managing and tracking the progress of a leadership program. It is designed to be hosted within Microsoft Authenticated platforms (Sharepoint, Azure...) since the data comes from Sharepoint.
